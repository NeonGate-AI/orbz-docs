...
The default performance architecture is server-first Nextra content with minimal client JavaScript. Treat `app/register-element.client.tsx`, theme/search UI, live Orbz examples, fonts/assets and Pagefind output as explicit performance surfaces. Preserve stable layout geometry and avoid adding dependencies or hydration solely to implement content presentation. Field Core Web Vitals claims require field evidence; lab/source work is diagnostic.
