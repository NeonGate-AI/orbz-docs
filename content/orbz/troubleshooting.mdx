...
Built-in appearances are NeonGate (default), `periwinkle`, `magenta`, `peach`,
`mocha`, and `ivory`. Read accepted keys from `ORBZ_PRESET_NAMES`; see
[preset naming](/orbz/concepts/appearance#neongate-preset-name).
