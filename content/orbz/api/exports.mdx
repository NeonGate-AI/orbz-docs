...
| `DEFAULT_ORBZ_PRESET` | Name of the default NeonGate preset; see [preset naming](/orbz/concepts/appearance#neongate-preset-name) |
...
| `normalizeOrbzPreset()` | Unsupported input becomes `DEFAULT_ORBZ_PRESET` |
