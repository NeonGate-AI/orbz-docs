...
const preset: OrbzPresetName = "gojhonny";
...
| `DEFAULT_ORBZ_PRESET` | `gojhonny` |
| `DEFAULT_ORBZ_COLORS` | The `gojhonny` preset colors |
...
| `normalizeOrbzPreset()` | Unsupported input becomes `gojhonny` |
