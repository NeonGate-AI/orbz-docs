...
| `preset` | `preset` | Canonical `ORBZ_PRESET_NAMES` values and the deprecated `gojhonny` alias; see [preset naming](/orbz/concepts/appearance#neongate-preset-name) | `neongate` (`DEFAULT_ORBZ_PRESET`) |
...
there is no `palette` attribute or property. See
[NeonGate preset naming](/orbz/concepts/appearance#neongate-preset-name) for the
deprecated alias and canonical normalization behavior.
