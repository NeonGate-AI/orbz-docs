...
export function AssistantPresence() {
  ...
  return (
    <div role="status" aria-live="polite">
      <orb-z state={state} preset="gojhonny" size="300px" />
...
export function AssistantPresence() {
  return <orb-z state="thinking" preset="gojhonny" size="300px" />;
}
```
...
export function ProductPresence(props: ProductPresenceProps) {
  ...
  return <orb-z ref={setElement} state="idle" preset="gojhonny" />;
}
```
