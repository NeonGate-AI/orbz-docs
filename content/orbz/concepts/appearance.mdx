...
The deprecated `gojhonny` input remains accepted by preset attributes,
...
Omitting `preset` also lets custom colors take effect. Generate new picker
options from your installed package's `ORBZ_PRESET_NAMES`, and see the
[1.0.2 release notes](/orbz/changelog#102--2026-09-08) when upgrading from 1.0.1.
